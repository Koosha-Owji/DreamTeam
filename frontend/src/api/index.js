...
export const add_contact_label = (label_id, id) =>
  API.patch(`contacts/update/${id}/label/${label_id}`);
export const delete_contact_label = (label_id, id) =>
  API.patch(`contacts/update/${id}/delabel/${label_id}`);

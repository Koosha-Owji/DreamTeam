...
export const create_meeting = async (req, res) => {
    ...
    try {
        ...
        const newMeeting = meetingModel.create({...req.body, user_id: req.user_id, date_time: date});
...
export const delete_meeting = async (req, res) => {
    ...
    try {
        ...
        res.send("Successfully deleted meeting (or meeting does not exist or user is not authorised)");
...
export const get_all_meetings = async (req, res) => {
    ...
    try {
        ...
        if (! meetings) return res.json({message: "No meetings associated with this user"});
...
export const update_meeting = async (req, res) => {
    try {
        ...
        await meetingModel.findByIdAndUpdate(req.params.id, 
            {title: req.body.title, agenda: req.body.agenda, attendees: req.body.attendees}).exec();

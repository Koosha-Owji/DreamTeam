...
export declare namespace datafusion_v1beta1 {
    ...
    export class Resource$Projects$Locations$Instances$Dnspeerings {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        add(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Add, options: StreamMethodOptions): GaxiosPromise<Readable>;
        add(params?: Params$Resource$Projects$Locations$Instances$Dnspeerings$Add, options?: MethodOptions): GaxiosPromise<Schema$AddDnsPeeringResponse>;
        add(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Add, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        add(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Add, options: MethodOptions | BodyResponseCallback<Schema$AddDnsPeeringResponse>, callback: BodyResponseCallback<Schema$AddDnsPeeringResponse>): void;
        add(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Add, callback: BodyResponseCallback<Schema$AddDnsPeeringResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        remove(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Remove, options: StreamMethodOptions): GaxiosPromise<Readable>;
        remove(params?: Params$Resource$Projects$Locations$Instances$Dnspeerings$Remove, options?: MethodOptions): GaxiosPromise<Schema$RemoveDnsPeeringResponse>;
        remove(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Remove, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        remove(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Remove, options: MethodOptions | BodyResponseCallback<Schema$RemoveDnsPeeringResponse>, callback: BodyResponseCallback<Schema$RemoveDnsPeeringResponse>): void;
        remove(params: Params$Resource$Projects$Locations$Instances$Dnspeerings$Remove, callback: BodyResponseCallback<Schema$RemoveDnsPeeringResponse>): void;
        remove(callback: BodyResponseCallback<Schema$RemoveDnsPeeringResponse>): void;
    }
    export interface Params$Resource$Projects$Locations$Instances$Dnspeerings$Add extends StandardParameters {
        /**
         * The resource on which DNS peering will be created.
         */
        parent?: string;
    ...
    export interface Params$Resource$Projects$Locations$Instances$Dnspeerings$Remove extends StandardParameters {
        /**
         * The resource on which DNS peering will be removed.
         */
        parent?: string;

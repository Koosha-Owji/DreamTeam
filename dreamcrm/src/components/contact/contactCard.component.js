...
const Contact = props =>(
    ...
    props.contactDetails.business,
    props.contactDetails.relationship,
    props.contactDetails.phone_number,
    props.contactDetails.email_address,
    props.contactDetails.description
  )
